    ...
    return (
        ...
        (l = function (a) {
            ...
            if (
                ...
                for (
                    ...
                    (i = !!r[l].attributes.required),
                        "fieldset" !== r[l].nodeName.toLowerCase() && s(r[l]);
        }),
        (s = function (e) {
            var t = e,
                a = h(t),
                ...
                b = m(t, "max"),
                g = !(
                    "" === t.validationMessage || void 0 === t.validationMessage
                );
        ...
        (o = function (e) {
            ...
            !L.test(t.nodeName) ||
                ...
                ((i = e.type),
                v() || s(t),
                (t.validity.valid && ("" !== t.value || l.test(t.type))) ||
                (t.value !== t.getAttribute("placeholder") && t.validity.valid)
                    ? (A(t, [n.invalidClass, n.requiredClass]),
                      N(t, n.validClass))
                    : a.test(i)
                    ? t.validity.valueMissing &&
                      A(t, [n.requiredClass, n.invalidClass, n.validClass])
                    : t.validity.valueMissing
                    ? (A(t, [n.invalidClass, n.validClass]),
                      N(t, n.requiredClass))
                    : t.validity.valid ||
                      (A(t, [n.validClass, n.requiredClass]),
                      N(t, n.invalidClass)),
                "input" === i && u && (y(t.form, "keyup", o, !0), (u = !1)));
        }),
        (d = function (t) {
            var a,
                i,
            ...
            if ("form" === t.nodeName.toLowerCase()) {
                ...
                for (var d = 0, c = a.length; c > d; d++)
                    (i = a[d]),
                        (r = !!i.attributes.disabled),
                        (l = !!i.attributes.required),
                        (s = !!i.attributes.pattern),
        ...
        (f = function (e) {
            ...
            s ||
                ...
                l.test(e.type) ||
                ("" !== e.value || a.test(i)
                    ? e.value === t.placeholder &&
                      a.test(i) &&
                      ((e.value = ""), A(e, n.placeholderClass))
                    : ((e.value = t.placeholder),
                      g(
                          e.form,
                          "submit",
        ...
        (h = function (e) {
            ...
            return !(
                !i ||
                ("" !== e.value && e.value !== t && (!a.test(e.type) || $(e)))
            );
        }),
        (g = function (e, t, a, i) {
        ...
        ($ = function (e) {
            for (
                var t = document.getElementsByName(e.name), a = 0;
                t.length > a;
                a++
            )
