    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <form role="form" class="form-horizontal" method="POST" action="{{ route('admin.esp.update', $item->id) }}" enctype="multipart/form-data">
                    <!-- /.card-header -->
                    <div class="card-body">
                        @csrf
                        @method('PATCH')
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <div class="card card-info">
                                    ...
                                    <div class="card-body">
                                        <a href="{{ asset('img/esp').'/'.$item->icon }}">
                                            <img src="{{ asset('img/esp').'/'.$item->icon }}" alt="" class="img img-responsive">
                                        </a>
                                    </div>
                                </div>
                            </div>
